  ...
  function customCSS()
  {
	...
	function bannerize( $theArgs ) {
		...
		$default = array ( 'group'        => '',
		                   ...
		                   'categories'   => '',
		                   'limit'        => '',
		                   'before'       => '<div class="col-sm-4 item-link">',
		                   'after'        => '</div>' );
		...
		<?php if ( $args['no_html_wrap'] == '0' ) : ?>
				<div class="wp_bannerize container <?php if ( $args['group'] != '' ) {
					echo $args['group'];
				} ?>">
			<?php endif; ?>
                                    <div class="row">
                                    <!-- TITULO DA SEÇÃO LINKS ÚTEIS -->
                                    <?php $regina_lite_section_title = get_theme_mod( 'Links Úteis', __( 'Links Úteis', 'regina-lite' ) );?>
                                    <div class='title-links-uteis'>
                                        <?php echo '<h2>' . esc_html( $regina_lite_section_title ) . '</h2> <hr>';?>
                                    </div>
                                    <!-- FIM TÍTULO DA SEÇÃO -->
