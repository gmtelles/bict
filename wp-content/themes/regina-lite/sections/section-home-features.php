...
<div class="container">
	<div class="row">
		...
		<?php endif; ?>
		<div id="services-title-block" class="col-xs-12" style="<?php if ( $top_box_show != 1 ): echo 'margin-top: 20px;'; endif; ?>">
				...
				<div class="service">
					<div class="icon">
						<!--<span class="nc-icon-outline health_heartbeat-16"></span>-->
                                            <span><img src="http://localhost/bict/wp-content/uploads/2017/06/b-mecanica.png" /></span>
					</div>
					...
					<?php if ( $features_feature1_buttonurl ): ?>
						<a href="<?php echo esc_url( $features_feature1_buttonurl ); ?>" class="link small"><?php _e( 'Conheça Mais', 'regina-lite' ); ?>
							<span class="nc-icon-glyph arrows-1_bold-right"></span></a>
					<?php endif; ?>
				</div><!--.service-->
			</div><!--.col-lg-3-->
				...
				<div class="service">
					<div class="icon">
						<!--<span class="nc-icon-outline food_apple"></span>-->
                                                <span><img src="http://localhost/bict/wp-content/uploads/2017/06/i-civil.png" /></span>
					</div>
					...
					<?php if ( $features_feature2_buttonurl ): ?>
						<a href="<?php echo esc_url( $features_feature2_buttonurl ); ?>" class="link small"><?php _e( 'Conheça Mais', 'regina-lite' ); ?>
							<span class="nc-icon-glyph arrows-1_bold-right"></span></a>
					<?php endif; ?>
				</div><!--.service-->
			</div><!--.col-lg-3-->
				...
				<div class="service">
					<div class="icon">
						<!--<span class="nc-icon-outline health_hospital-32"></span>-->
                                                <span><img src="http://localhost/bict/wp-content/uploads/2017/06/c-computacao.png" /></span>
					</div>
					...
					<?php if ( $features_feature3_buttonurl ): ?>
						<a href="<?php echo esc_url( $features_feature3_buttonurl ); ?>" class="link small"><?php _e( 'Conheça Mais', 'regina-lite' ); ?>
							<span class="nc-icon-glyph arrows-1_bold-right"></span></a>
					<?php endif; ?>
				</div><!--.service-->
			</div><!--.col-lg-3-->
				...
				<div class="service">
					<div class="icon">
						<!--<span class="nc-icon-outline health_brain"></span>-->
                                                <span><img src="http://localhost/bict/wp-content/uploads/2017/06/t-ambiental.png" /></span>
					</div>
					...
					<?php if ( $features_feature4_buttonurl ): ?>
						<a href="<?php echo esc_url( $features_feature4_buttonurl ); ?>" class="link small"><?php _e( 'Conheça Mais', 'regina-lite' ); ?>
							<span class="nc-icon-glyph arrows-1_bold-right"></span></a>
					<?php endif; ?>
				</div><!--.service-->
			</div><!--.col-lg-3-->
